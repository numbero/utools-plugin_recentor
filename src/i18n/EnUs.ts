...
export class EnUs implements Sentence {
    ...
    readonly macVscodeCliLabel: string = 'Official VS Code CLI path'
    readonly macVscodeCliHelp: string = 'Select Contents/Resources/app/bin/code inside the app bundle. Example: /Applications/Visual Studio Code.app/Contents/Resources/app/bin/code. In the file picker, press ⌘⇧G, paste the full path, then select the code file. Do not select .app or Contents/MacOS/Code, or enter a bare code command or extra arguments. /usr/local/bin/code is accepted only if it is a valid symlink to the official CLI.'
    readonly macVscodeCliInvalid: string = 'This path is not a usable official VS Code CLI. Select an existing, executable CLI file.'
